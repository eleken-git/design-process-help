...
[`docs/3d/index.html`](docs/3d/index.html) — плеєр на Three.js з перемикачем епізодів (кнопка «Епізоди»), розділами, паузою, перемоткою і музикою з кнопкою вимкнення. Кожен епізод має свій трек у стилі cosmic relaxation з фортепіано.
