...
Кожна анімація — епізод у спільному 3D-плеєрі (`docs/3d/`, модуль `docs/3d/episodes/<тема>.js`) плюс відео з озвученим текстом і ембіент-музикою. Стиль спільний: GitHub Dark, ті самі персонажі Аня і Богдан, той самий тренувальний проєкт Nimbus.
